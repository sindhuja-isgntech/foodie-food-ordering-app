...
const mockRestaurantData: Record<string, Restaurant> = {
  '1': {
    ...
    menu: {
      ...
      items: [
        ...
        { id: 104, name: 'Chocolate Milkshake', price: '$4.50', description: 'Rich chocolate ice cream topped with whipped cream', img: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&w=400&q=80', category: 'Drinks' },
      ],
    },
  },
  '2': {
    ...
    menu: {
      ...
      items: [
        ...
        { id: 203, name: 'Penne Carbonara', price: '$15.25', description: 'Crispy pancetta, egg yolk, and pecorino romano', img: 'https://images.unsplash.com/photo-1612874742237-6526221588e3?auto=format&fit=crop&w=400&q=80', category: 'Pasta' },
        { id: 204, name: 'Classic Tiramisu', price: '$6.99', description: 'Espresso-soaked ladyfingers with mascarpone cream', img: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?auto=format&fit=crop&w=400&q=80', category: 'Desserts' },
      ],
    },
  },
  '3': {
  ...
  '5': {
    ...
    menu: {
      ...
      items: [
        { id: 501, name: 'Butter Chicken (Murgh Makhani)', price: '$15.99', description: 'Tender chicken cooked in a rich, velvety tomato and butter cream sauce', img: 'https://images.unsplash.com/photo-1588166524941-3bf61a9c41db?auto=format&fit=crop&w=400&q=80', category: 'Curries' },
        { id: 502, name: 'Paneer Tikka Masala', price: '$13.99', description: 'Grilled cottage cheese cubes simmered in a spiced onion-tomato gravy', img: 'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=400&q=80', category: 'Curries' },
        { id: 503, name: 'Crispy Vegetable Samosas (2 pcs)', price: '$5.49', description: 'Golden pastry stuffed with spiced potatoes and green peas', img: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=400&q=80', category: 'Starters' },
        { id: 504, name: 'Garlic Butter Naan', price: '$3.49', description: 'Freshly baked tandoori flatbread brushed with garlic and melted butter', img: 'https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&w=400&q=80', category: 'Breads' },
        { id: 505, name: 'Gulab Jamun (2 pcs)', price: '$4.99', description: 'Warm milk-solid dumplings soaked in rose-flavored cardamom syrup', img: 'https://images.unsplash.com/photo-1605197586548-06a888d051b7?auto=format&fit=crop&w=400&q=80', category: 'Desserts' },
      ],
    },
  },
  '6': {
...
export const RestaurantDetails: React.FC = () => {
  ...
  const restaurant = (id && mockRestaurantData[id]) ? mockRestaurantData[id] : mockRestaurantData['1'];
      ...
      <div className="relative h-64 md:h-80 rounded-3xl overflow-hidden mb-8">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex items-end p-6 md:p-8">
          <div className="text-white">
            <span className="bg-orange-500 text-xs px-3 py-1 rounded-full font-semibold uppercase">{restaurant.tag}</span>
